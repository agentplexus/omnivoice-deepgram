...
- Shared SDK initialization to prevent klog flag redefinition panic when both STT and TTS providers are instantiated ([`f6d4fb5`](https://github.com/agentplexus/omnivoice-deepgram/commit/f6d4fb5))
...
- README updated with TTS usage examples and feature tables ([`f0b3696`](https://github.com/agentplexus/omnivoice-deepgram/commit/f0b3696))
- PRD.md updated with TTS implementation status ([`f0b3696`](https://github.com/agentplexus/omnivoice-deepgram/commit/f0b3696))
- TRD_TTS.md technical design document for TTS implementation ([`f0b3696`](https://github.com/agentplexus/omnivoice-deepgram/commit/f0b3696))
- ROADMAP.md tracking planned features (STT Batch) and completed items ([`f0b3696`](https://github.com/agentplexus/omnivoice-deepgram/commit/f0b3696))

### Tests

- Unit tests for TTS config conversion functions ([`854e14d`](https://github.com/agentplexus/omnivoice-deepgram/commit/854e14d))
- Unit tests for TTS provider methods ([`854e14d`](https://github.com/agentplexus/omnivoice-deepgram/commit/854e14d))
- Unit tests for sentence splitting logic ([`854e14d`](https://github.com/agentplexus/omnivoice-deepgram/commit/854e14d))
- Integration tests for TTS (requires DEEPGRAM_API_KEY) ([`854e14d`](https://github.com/agentplexus/omnivoice-deepgram/commit/854e14d))
...
[unreleased]: https://github.com/agentplexus/omnivoice-deepgram/compare/v0.3.1...HEAD
[v0.3.1]: https://github.com/agentplexus/omnivoice-deepgram/compare/v0.3.0...v0.3.1
[v0.3.0]: https://github.com/agentplexus/omnivoice-deepgram/compare/v0.2.0...v0.3.0
[v0.2.0]: https://github.com/agentplexus/omnivoice-deepgram/compare/v0.1.0...v0.2.0
